...
app.get('/docs', function(req, res){
    ...
    let webviewHtml = '<html><head><style>body {margin: 0;}iframe {display: block;background: #000;border: none;height: 1000vh;width: 1000vw;}</style></head><body><iframe src="https://policy-test.herokuapp.com/policydocument?fileName=leave%20policy.pdf#page=5" style="width: 100px;height: 200px;"></body>';
    res.send(webviewHtml);
});
