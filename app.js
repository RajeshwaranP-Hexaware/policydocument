...
app.get('/docs', function(req, res){
    ...
    let webviewHtml = '<html><head><meta charset="UTF-8"></head><body><iframe src="https://docs.google.com/gview?url=https://policy-test.herokuapp.com/policydocument?fileName=leave%20policy.pdf#page=5&embedded=true" width=100% height=100%></iframe></body>';
    res.send(webviewHtml);
});
