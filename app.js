...
app.get('/docs', function(req, res){
    ...
    let webviewHtml = '<html><head><meta charset="UTF-8"></head><body><iframe src="https://policy-test.herokuapp.com/policydocument?fileName=leave%20policy.pdf#page=5" </body>';
    res.send(webviewHtml);
});
