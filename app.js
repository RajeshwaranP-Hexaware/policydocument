...
app.get('/docs', function(req, res){
    ...
    let webviewHtml = '<html><head><meta charset="UTF-8"></head><body><embed src="https://policy-test.herokuapp.com/policydocument?fileName=leave%20policy.pdf#page=7" width=90% height=90%></body>';
    res.send(webviewHtml);
