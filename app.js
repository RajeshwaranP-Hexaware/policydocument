...
app.get('/docs', function(req, res){
    ...
    let webviewHtml = '<html><head></head><body><iframe src="https://policy-test.herokuapp.com/policydocument?fileName=leave%20policy.pdf#page=5" style="width: 1000px;height: 1000px;"></body>'
    res.send(webviewHtml);
});
